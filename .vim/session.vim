...
nnoremap <C-C> :qa
nnoremap <F12> :split $MYVIMRC
nnoremap <Insert> :-1read ~/Documents/coding/vim/boilerplate/
noremap <Del> <Nop>
noremap <F1> <Nop>
noremap <Right> <Nop>
noremap <Left> <Nop>
...
set viminfofile=./.vim/viminfo.vim
set nowrapscan
let s:so_save = &g:so | let s:siso_save = &g:siso | setg so=0 siso=0 | setl so=-1 siso=-1
let v:this_session=expand("<sfile>:p")
silent only
silent tabonly
cd ~/Documents/coding/python/aenir
...
%argdel
$argadd .
edit ~/Documents/coding/python/aenir
argglobal
let s:cpo_save=&cpo
set cpo&vim
...
keepjumps 8
normal! 0
lcd ~/Documents/coding/python/aenir
tabnext 1

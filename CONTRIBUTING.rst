...
``aenir`` documentation uses Sphinx_ as its main documentation compiler.
...
.. _repository: https://github.com/<USERNAME>/aenir
.. _issue tracker: https://github.com/<USERNAME>/aenir/issues
.. <-- end -->
